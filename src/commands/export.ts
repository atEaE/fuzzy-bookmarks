...
import { BookmarksInfo } from '../models/bookmark';
 ...
 * @returns void
 */
export function exportExecute(config: FzbConfig): void {
    ...
    try {
        var currentRootFolder = vscode.workspace.workspaceFolders ? vscode.workspace.workspaceFolders[0].uri.path : undefined;
